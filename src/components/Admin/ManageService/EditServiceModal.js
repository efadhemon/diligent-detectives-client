...
const EditServiceModal = ({ modalIsOpen, closeModal, isEditedSuccess,  setIsEditedSuccess, service: { _id, name, cost, description } }) => {
    ...
    const onSubmit = data => {
        fetch(`https://diligent-detectives-server.herokuapp.com/updateService/${_id}`, {
            method: 'PATCH',
            ...
            >
                ...
                <form className="p-3" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="form-group col-6">
                            <h3>Service Cost</h3>
                            <input className="form-control" type="text" name="cost" defaultValue={cost} placeholder="Service Cost" ref={register()} />
                        </div>
                    </div>
